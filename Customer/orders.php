...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['place_order'])) {
    ...
    if ($quantity < 6 || $quantity > 100) {
        echo '<script>alert("Quantity must be between 6 and 100."); window.location = "orders.php";</script>';
        exit();
    }
...
<head>
    ...
    <title>Place Order • De Chavez Waterhaus</title>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="px-3 mt-2" style="height: calc(100vh - 90px); overflow-y: auto; padding-bottom: 20px;">
            <ul class="nav flex-column">
                ...
                <li class="nav-item"><a href="orders.php" class="nav-link active"><i class="fas fa-shopping-cart me-3"></i> <span>Place Order</span></a></li>
    ...
    <div class="main-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h4 class="fw-bold mb-0">Place Your Order</h4>
                    <p class="text-muted mb-0 d-none d-sm-block">Select from our premium water collection</p>
                </div>
            </div>
        ...
        <?php if (!$isEmailVerified): ?>
            <div class="alert alert-warning d-flex align-items-center mb-4">
                ...
                <div>
                    ...
                    Please verify your account in <a href="profile.php" class="alert-link">Profile Settings</a> before placing an order.
                </div>
            </div>
        <?php endif; ?>
